...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Moxie Homes & Properties — Trusted Real Estate Investment in Nigeria" },
      { name: "description", content: "Genuine, affordable and exquisite homes and estates across Abuja and Nigeria. Trust, integrity and excellence in real estate investment." },
      { name: "author", content: "Moxie Homes And Properties Ltd" },
      { property: "og:title", content: "Moxie Homes & Properties" },
      { property: "og:description", content: "Utmost trust and credibility in real estate investment." },
